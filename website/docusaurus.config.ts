        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: "https://github.com/Automattic/pressship/issues"
            }
          ]
        }
      ],
      copyright: `
        <div class="pp-made-by">
          <span class="pp-made-by__kicker">Brought to you by your friends at</span>
          <a class="pp-made-by__wordmark" href="https://automattic.com" target="_blank" rel="noopener noreferrer">
            Automattic
          </a>
          <p class="pp-made-by__lead">
            We care about the open web — and the tools people and agents use to build and publish to it.
          </p>
          <p class="pp-made-by__products">
            We&rsquo;re the people behind
            <a href="https://wordpress.com" target="_blank" rel="noopener noreferrer">WordPress.com</a>,
            <a href="https://woocommerce.com" target="_blank" rel="noopener noreferrer">WooCommerce</a>,
            <a href="https://jetpack.com" target="_blank" rel="noopener noreferrer">Jetpack</a>,
            <a href="https://www.tumblr.com" target="_blank" rel="noopener noreferrer">Tumblr</a>,
            <a href="https://dayoneapp.com" target="_blank" rel="noopener noreferrer">Day One</a>,
            <a href="https://www.beeper.com" target="_blank" rel="noopener noreferrer">Beeper</a>,
            <a href="https://pocketcasts.com" target="_blank" rel="noopener noreferrer">Pocket Casts</a>,
            and <a href="https://automattic.com" target="_blank" rel="noopener noreferrer">more</a>.
          </p>
        </div>
        <div class="pp-footer-disclaimer">
          ...
          <p>
            <strong>Pressship is an Automattic-maintained community project.</strong>
            It is currently unofficial tooling for WordPress.org plugin publishing workflows,
            not an official WordPress.org service or a WordPress Foundation project.
            WordPress&reg; is a trademark of the WordPress Foundation.
          </p>
        </div>
